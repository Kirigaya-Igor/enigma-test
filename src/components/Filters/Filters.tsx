...
const battery = [{ name: 'Ladowanie baterii > 30%', value: '30' }, { name: 'Ladowanie baterii > 50%', value: '50' }, { name: 'Ladowanie baterii > 70%', value: '70' }, { name: 'Ladowanie baterii > 90%', value: '90' }]
